...
def test_graph_lifecycle(workspace):
  ...
  child = impl.propose_hypothesis("Per-head dropout helps more than shared dropout", parent_id=root)["node_id"]
  evidence = impl.attach_evidence(child, "Validation accuracy improved by 0.8 points", "supports")["evidence_id"]
