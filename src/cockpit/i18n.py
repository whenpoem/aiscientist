...
TEXT: dict[str, dict[str, str]] = {
    "en": {
        ...
        "audit_log_collapsed_hint": "▸ audit log ({count} hidden) — A to expand",
        "audit_log_expand": "A expand",
        "audit_log_collapse": "A collapse",
    ...
    "zh": {
        ...
        "audit_log_collapsed_hint": "▸ 审计日志（已隐藏 {count} 条）— A 展开",
        "audit_log_expand": "A 展开",
        "audit_log_collapse": "A 折叠",
